...
use plonky2::hash::monolith::MonolithHash;
use plonky2::plonk::config::{Hasher, KeccakHashConfig, PoseidonHashConfig, MonolithHashConfig};
use tynm::type_name;
...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    bench_merkle_tree::<GoldilocksField, MonolithHashConfig, MonolithHash>(c);
